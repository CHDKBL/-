...
class PropertiesPanel():
    ...
    def draw_items(screen):
        # 画框
        screen.blit(pygame.image.load(
            'resources/image/state.png').convert(), (600, 0))
    ...
    def showHelp(screen):
        ...
        screen.blit(PropertiesPanel.build_text(
            'W:上 A:左 S:下 D:右 空格:放炸弹'), (x + 30, y + first_y + 30 * 2))
        screen.blit(PropertiesPanel.build_text(
            '玩家2：'), (x + 30, y + first_y + 30 * 3))
        screen.blit(PropertiesPanel.build_text(
            '↑:上 ←:左 ↓:下 →:右 小键盘0：放炸弹'), (x + 30, y + first_y + 30 * 4))
        screen.blit(PropertiesPanel.build_text(
            '制作人：'), (x + 30, y + first_y + 30 * 6))
        screen.blit(PropertiesPanel.build_text(
            '陈浩丹 石富文 杨东海 陈伟康'), (x + 30, y + first_y + 30 * 7))
        return x, y, w
